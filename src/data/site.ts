...
// 会社理念（本文は現行サイト「会社理念」より[実]／見出しキーワードは当方付与[案]）
export const PHILOSOPHY = {
  lead: '私たちが大切にしている、3つの想いです。',
  items: [
    { title: '誠実と進化', text: '常に誠実な心で行動し、時代とともに進化を遂げる会社を目指す。' },
    { title: 'お客様起点', text: 'お客様のニーズや社会的課題に寄り添い、最適なソリューションを提供する。' },
    { title: '人の成長', text: '社員一人ひとりの個性や能力を最大限に伸ばし、誰もが生き生きと輝きながら働ける環境づくりに力を注ぐ。' },
  ],
} as const;

// 代表ご挨拶（現行サイト「代表ご挨拶」より、文意を保ったまま読みやすく調整）[実]
export const CEO_MESSAGE = {
  paragraphs: [
    'この度は、株式会社オアシス情報システムズのホームページをご覧いただき、誠にありがとうございます。',
    '弊社は2017年4月に設立した、まだ若く、成長を続けている会社です。',
    '私の理念は、『常に誠実な心で行動し、お客様のニーズや社会的課題に寄り添った最適なソリューションを提供する』こと。この志は、これからも変わることはありません。一つひとつ誠実にサービスを提供し続けることこそが、当社の使命だと考えています。',
    'また、社員一人ひとりの個性と能力を最大限に伸ばし、誰もが生き生きと輝きながら働き、人として成長できる、そうした環境を大切にする会社でありたいと考えています。',
    'お客様への感謝を忘れることなく、太く長く繁栄し、関わるすべての人に感動をお届けできる企業として、これからも成長・発展してまいります。',
    '今後とも、皆様の一層のご支援、ご指導を賜りますようお願い申し上げます。',
  ],
  title: '代表取締役',
  name: '李 雄',
} as const;
...
export const STRENGTHS = [
  {
    icon: 'flow',
    title: '一貫対応のワンストップ体制',
    text: '開発・クラウド・人材の3領域を自社で対応。上流の提案から開発・運用まで切れ目なく伴走し、窓口の一本化でスピードと品質を両立します。',
  },
  {
    icon: 'shield',
    title: '情報セキュリティへの徹底',
